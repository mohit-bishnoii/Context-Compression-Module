...
class CCMAgent:
    ...
    def chat(self, user_message: str) -> dict:
        ...
        try:
            ...
            # Around line 377 in travel_agent/agent.py
# ── Step 4: Handle tool calls ────────────────────────
            max_tool_rounds = 5
            tool_round = 0

            # FIX: Initialize tool_messages ONCE outside the while loop
            ...
            while (
                ...
                # FIX: Append the assistant's tool request to the history
                ...
                for tool_call in tool_calls:
                    ...
                    # CCM processes and compresses the result
                    ...
                    # FIX: Append the COMPRESSED tool result to the running history
                ...
                # Call LLM again with the CUMULATIVE history
                response = self.client.chat.completions.create(
                    model=self.model,
